...
void walk()
{
    if (walktemp==1)
    {
            move(1,80,50,120,500);
            move(3,80,50,120,500);
            move(2,40,50,120,500);
            move(4,40,50,120,500);
        ...
        if (walktemp==2)
    {
            move(1,60,50,120,500);
            move(3,20,50,120,500);
            move(2,20,50,120,500);
            move(4,60,50,120,500);
    ...
    if (walktemp==3)
    {
            move(1,40,50,120,500);
            move(3,40,50,120,500);
            move(2,80,50,120,500);
            move(4,80,50,120,500);
    ...
    if (walktemp==4)
    {
            move(1,20,50,120,500);
            move(3,60,50,120,500);
            move(2,60,50,120,500);
            move(4,20,50,120,500);
...
//            move(4,50,50,120);   
        ...
        while(s2==2)
        {
            move(1,50.0,50.0,70.0,0);
           
            move(2,50.0,50.0,70.0,0);

            move(3,50.0,50.0,70.0,0);

            move(4,50.0,50.0,70.0,0);
